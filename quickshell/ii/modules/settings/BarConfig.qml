...
ContentSection {
    ...
    ConfigSlider {
        buttonIcon: "background_dot_large"
    ...
    ContentSubsection {
        ...
        ConfigSelectionArray {
            ...
            options: [
                ...
                { displayName: Translation.tr("Fidelity"),    icon: "tune",           value: "scheme-fidelity" },
                { displayName: Translation.tr("Monochrome"),  icon: "contrast",       value: "scheme-monochrome" },
                { displayName: Translation.tr("Neutral"),     icon: "circle",         value: "scheme-neutral" },
                { displayName: Translation.tr("Tonal Spot"),  icon: "lens_blur",      value: "scheme-tonal-spot" }
            ]
        }
    }
}
